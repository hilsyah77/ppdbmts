...
export const ModalCetakFormulir: React.FC<ModalCetakProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/70 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4 overflow-y-auto print:p-0 print:m-0 print:bg-white print:fixed print:inset-0 print:overflow-hidden">
      {/* Embedded Print Styles for Strict 1-Page Layout & Zero Scrollbars */}
      <style>{`
        @page {
          size: auto;
      ...
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[92vh] overflow-y-auto shadow-2xl border border-slate-200 flex flex-col print:shadow-none print:border-none print:max-w-none print:max-h-none print:w-full print:rounded-none print:overflow-hidden print:p-0 print:m-0">
        ...
        <div className="bg-slate-200/70 p-3 sm:p-5 flex justify-center print:bg-white print:p-0 print:m-0">
          {/* Printable Paper Area (Guaranteed Single Page Height & No Scrollbar Artifacts) */}
          <div
            id="printable-formulir-ppdb"
            ref={printRef}
            className="w-full max-w-3xl bg-white text-slate-900 shadow-xl border border-slate-300 print:border-none print:shadow-none p-5 sm:p-7 font-sans leading-tight text-[10.5px] print:p-0"
            ...
            <div className="space-y-2 text-[10px] text-slate-900">
              ...
              <div className="border border-slate-300 rounded overflow-hidden">
                <div className="bg-slate-800 text-white px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider flex items-center justify-between">
                  ...
                  <span className="text-[8.5px] font-mono text-emerald-300 font-normal">Data Utama Siswa</span>
                </div>
                <table className="w-full text-[9.5px] border-collapse">
                  <tbody>
                    ...
                    <tr>
                      <td className="py-1 px-2.5 font-medium bg-slate-50 border-r border-slate-200 text-slate-700">6. Alamat Lengkap Siswa</td>
              ...
              <div className="pt-1.5 border-t border-slate-300 text-[8px] text-slate-500 flex justify-between items-center">
                ...
                <span className="font-mono font-semibold">1 Halaman Dokumen Resmi</span>
              </div>
        ...
        <div className="p-3.5 bg-slate-50 border-t border-slate-200 flex justify-between items-center rounded-b-2xl print:hidden">
          <div className="text-[11px] text-slate-500 flex items-center gap-1.5">
            ...
            Format cetak otomatis pas **1 Halaman** tanpa garis scrollbar saat dicetak atau disimpan ke PDF.
          </div>
          <div className="flex items-center gap-2">
            <button
              onClick={onClose}
